...
public class SupportRequest
{
    ...
    public void setMessage(final SupportMessage message) {
    ...
    public boolean equals(final Object o) {
        ...
        final SupportRequest other = (SupportRequest)o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof SupportRequest;
    }
    ...
    public String toString() {
        return "SupportRequest(context=" + this.getContext() + ", message=" + this.getMessage() + ")";
    }
}
