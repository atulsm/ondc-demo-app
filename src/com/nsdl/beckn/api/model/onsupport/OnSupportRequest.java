...
public class OnSupportRequest
{
    ...
    public void setMessage(final OnSupportMessage message) {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof OnSupportRequest)) {
            return false;
        }
        final OnSupportRequest other = (OnSupportRequest)o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof OnSupportRequest;
    }
    ...
    public String toString() {
        return "OnSupportRequest(context=" + this.getContext() + ", message=" + this.getMessage() + ")";
    }
}
