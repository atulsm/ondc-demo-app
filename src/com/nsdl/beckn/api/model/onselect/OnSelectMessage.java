...
public class OnSelectMessage
{
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof OnSelectMessage)) {
            return false;
        }
        final OnSelectMessage other = (OnSelectMessage)o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof OnSelectMessage;
    }
    ...
    public String toString() {
        return "OnSelectMessage(order=" + this.getOrder() + ")";
    }
}
